...
console.log(" got acces tocken named :" + accestocken )
    ...
    try {
      const response = await axios.patch('/auth/property-owners/profile/complete', 
              {data}
            , {
                headers: {
    ...
    <div className='border p-9 rounded-md space-y-6'>     
        ...
        <div   className='flex justify-between gap-4'>
          ...
          <div className='space-y-6 w-[48%]'>
            ...
            <div className='space-y-4 flex flex-col'>
              <p>
                <span className='text-[#161C2D] font-semibold text-[16px]'>Property Type</span>
              </p>
              <input type="text"  onChange={(e) => setPropertyType(e.target.value)}  className='border p-2 rounded-md text-[14px]' placeholder='i.e. John Doe' />
            </div>
